...
public class TesteIAElaborada {
	...
	@Before
	public void before() {
		ia = new IAElaborada("", TipoCorJogador.PRETO, 30, 45, true);
	...
	public void escolherJogada() throws CasaOcupadaException,
		...
		/**
		 * O teste a seguir apenas não funcionará em duas situações: 1) Houverem
		 * peças no tabuleiro, mas não existir algum dos reis 2) A análise
		 * começar já estando, da última jogada do jogador humano, o seu rei em
		 * xeque, ou seja, o jogador humano ter realizado uma jogada que o
		 * coloca em xeque Como ambas as situações são atípicas e impossíveis de
		 * ocorrer no xadrez, ambas as situações não são tratadas. Contudo, ao
		 * forçar tais situações em testes você receberá um erro.
		 */

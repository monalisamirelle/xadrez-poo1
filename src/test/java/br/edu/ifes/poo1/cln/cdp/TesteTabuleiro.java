...
public class TesteTabuleiro {
	...
	public void roqueMenor() throws CasaOcupadaException {
		...
		Assert.assertTrue(tabuleiro.ehRoqueMenor(new Jogador("TesteB",
				CorJogador.BRANCO)));

		// Testa Roque menor das peças brancas se houver uma peça no caminho
		tabuleiro.colocarPeca(new Posicao(6, 1), cavaloBranco);
		Assert.assertFalse(tabuleiro.ehRoqueMenor(new Jogador("TesteB",
				CorJogador.BRANCO)));
		...
		Assert.assertTrue(tabuleiro.ehRoqueMenor(new Jogador("TesteP",
				CorJogador.PRETO)));

		// Testa Roque menor das peças pretas se houver uma peça no caminho
		tabuleiro.colocarPeca(new Posicao(6, 8), cavaloPreto);
		Assert.assertFalse(tabuleiro.ehRoqueMenor(new Jogador("TesteP",
				CorJogador.PRETO)));
	...
	public void roqueMaior() throws CasaOcupadaException {
		...
		Assert.assertTrue(tabuleiro.ehRoqueMaior(new Jogador("TesteB",
				CorJogador.BRANCO)));

		// Testa Roque menor das peças brancas se houver uma peça no caminho
		tabuleiro.colocarPeca(new Posicao(3, 1), cavaloBranco);
		Assert.assertFalse(tabuleiro.ehRoqueMaior(new Jogador("TesteB",
				CorJogador.BRANCO)));
		...
		Assert.assertTrue(tabuleiro.ehRoqueMaior(new Jogador("TesteP",
				CorJogador.PRETO)));

		// Testa Roque menor das peças pretas se houver uma peça no caminho
		tabuleiro.colocarPeca(new Posicao(3, 8), cavaloPreto);
		Assert.assertFalse(tabuleiro.ehRoqueMaior(new Jogador("TesteP",
				CorJogador.PRETO)));
